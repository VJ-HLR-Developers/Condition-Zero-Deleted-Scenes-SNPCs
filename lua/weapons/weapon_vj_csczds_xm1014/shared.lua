...
SWEP.WorldModel_CustomPositionAngle = Vector(0,15.2,0)
...
SWEP.Primary.Sound				= {"vj_hlr/czeror_weapon/xm1014/xm1014-1.wav"}
SWEP.Primary.DistantSound		= {"vj_hlr/czeror_weapon/xm1014/xm1014-distant.wav"}
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_ShotgunShell1"

-- Custom
SWEP.HLR_ValidModels = {"models/vj_hlr/czeror/arctic.mdl","models/vj_hlr/czeror/italian_vip.mdl","models/vj_hlr/czeror/militia.mdl","models/vj_hlr/czeror/guerilla.mdl","models/vj_hlr/czeror/gsg9.mdl","models/vj_hlr/czeror/asian.mdl","models/vj_hlr/czeror/leet.mdl","models/vj_hlr/czeror/asian_punk.mdl","models/vj_hlr/czeror/gign.mdl","models/vj_hlr/czeror/terror.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
