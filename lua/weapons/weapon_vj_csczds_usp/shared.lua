...
SWEP.NPC_ReloadSound			= {"vj_hlr/czeror_weapon/usp/usp_reload.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
SWEP.NPC_CanBePickedUp			= false -- Can this weapon be picked up by NPCs? (Ex: Rebels)
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.MadeForNPCsOnly 			= true -- Is this weapon meant to be for NPCs only?
SWEP.WorldModel					= "models/vj_hlr/czeror/weapons/w_usp.mdl"
...
SWEP.WorldModel_CustomPositionOrigin = Vector(0,-8.5,-0.5)
SWEP.WorldModel_CustomPositionBone = "Bip01 R Hand" -- The bone it will use as the main point
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage				= 4 -- Damage
SWEP.Primary.ClipSize			= 12 -- Max amount of bullets per clip
SWEP.Primary.Ammo				= "Pistol" -- Ammo type
SWEP.Primary.Sound				= {"vj_hlr/czeror_weapon/usp/usp1.wav"}
SWEP.Primary.DistantSound		= {"vj_hlr/czeror_weapon/usp/usp2-distant.wav"}
